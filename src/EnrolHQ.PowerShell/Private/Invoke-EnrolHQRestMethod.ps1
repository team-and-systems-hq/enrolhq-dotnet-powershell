function Invoke-EnrolHQRestMethod {
    ...
    if (-not $script:EnrolHQConnection) {
        throw 'Not connected to EnrolHQ. Run Connect-EnrolHQ first.'
    }
    ...
    if ($Body) {
        ...
        Write-Debug "EnrolHQ: Request body: $($requestParams['Body'])"
    }
    ...
    for ($attempt = 0; $attempt -le $maxRetries; $attempt++) {
        ...
        try {
            ...
            Write-Debug "EnrolHQ: HTTP $statusCode - $responseBody"
