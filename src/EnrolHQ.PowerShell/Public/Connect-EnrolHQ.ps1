function Connect-EnrolHQ {
    ...
    .PARAMETER Instance
        The EnrolHQ instance name (e.g., "yourschool"). The base URL will be
        constructed as https://{Instance}.enrolhq.com.au/api/v2/
    .PARAMETER ApiToken
    ...
    .EXAMPLE
        Connect-EnrolHQ -Instance 'myschool' -ApiToken 'your_token_here'

        Connect using explicit parameters.
    .EXAMPLE
        $env:ENROLHQ_INSTANCE = 'myschool'
    ...
    .EXAMPLE
        ...
        Connect using a custom base URL.
    .EXAMPLE
    ...
    elseif ($Instance) {
        $resolvedBaseUrl = "https://$Instance.enrolhq.com.au/api/v2/"
    }
    else {
        ...
        if (-not $resolvedBaseUrl) {
            ...
            if ($envInstance) {
                $resolvedBaseUrl = "https://$envInstance.enrolhq.com.au/api/v2/"
            }
        }
    }
