...
Connect-EnrolHQ -Instance 'demo.enrolhq.com.au' -ApiToken 'your-api-token-here'
...
# --- Option C: Connect with a full base URL override ---
# Connect-EnrolHQ -BaseUrl 'https://enrol.cranbrook.nsw.edu.au/api/v2/' -ApiToken $token
